...
Deno.test("maximum sum of k consecutive elements (brute force)", () => {
...
Deno.test("maximum sum of k consecutive elements", () => {
  assertEquals(0, sw.maxSumOfKConsecutiveElements([], 2));
  assertEquals(700, sw.maxSumOfKConsecutiveElements([100, 200, 300, 400], 2));
  assertEquals(
    39,
    sw.maxSumOfKConsecutiveElements([1, 4, 2, 10, 23, 3, 1, 0, 20], 4)
  );
});
